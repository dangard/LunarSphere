		...
		if (LunarSphereSettings.memoryDisableSkins) then
			...
			-- *******************************
				...
				function(self)
					...
					_G["LSSettingssphereColorColor"]:SetTexture(1,1,1);
			...
			-- ********************************
				...
				function(self)
					...
					_G["LSSettingsbuttonColorColor"]:SetTexture(1,1,1);
				...
				function(self)
					...
					_G["LSSettingsmenuButtonColorColor"]:SetTexture(0.3,0.6,1);
					Lunar.Button:UpdateButtonColors(true);
				end);
	...
	tempFrameContainer = tempObject;
		...
		tempObject = Lunar.Object:CreateCaption(10, sectionY, 150, 20, "|cFFFFFFFF"..Lunar.Locale["TOOLTIP_COLOR"], "tooltipColor", tempFrameContainer);
			...
			function(self)
				...
				_G["LSSettingstooltipBorderColor"]:SetTexture(db[1], db[2], db[3]);
				db = LunarSphereSettings.tooltipBackground;
				db[1] = 0.05;
				db[2] = 0.05;
				db[3] = 0.10;
				db[4] = 0.75;
				_G["LSSettingstooltipBackgroundColor"]:SetTexture(db[1], db[2], db[3]);
			end);
